...
function printCallArguments(path, options, print) {
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] for --paren-spacing option support (...)
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] with lastArgAddedLine arg for --paren-spacing option support
  function allArgsBrokenOut(lastArgAddedLine) {
    return group(
      [
        "(",
        // [prettierx merge update(s) from prettier@2.3.1 ...] keep break here, regardless of --paren-spacing option
        indent([line, ...printedArguments]),
        maybeTrailingComma,
        // [prettierx merge update(s) from prettier@2.3.1 ...] keep break here, unless lastArgAddedLine is true
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] with --paren-spacing option support below (...)
  ...
  if (shouldGroupFirst || shouldGroupLast) {
    ...
    // [prettierx merge update(s) from prettier@2.3.1 ...] keep for --paren-spacing option support (...)
