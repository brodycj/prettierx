...
const {
  ...
  isStringLiteral,
  isBinaryish,
  hasAddedLine, // [prettierx merge update(s) from prettier@2.3.1 ...] for templateCurlySpacing option support (...)
  hasComment,
  CommentCheckFlags,
...
function printJsxExpressionContainer(path, options, print) {
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] templateCurlySpacing option support (...)
  ...
  return [
    ...
    path.call(
      (p) => {
        ...
        // [prettierx merge update(s) from prettier@2.3.1 ...] with templateCurlySpacing option support (...)
        return [
          // [prettierx merge update(s) from prettier@2.3.1 ...] with templateCurlySpacing option support (...)
