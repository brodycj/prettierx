...
function printPropertyKey(path, options, print) {
  ...
  if (node.computed) {
    // [prettierx merge update(s) from prettier@2.3.1 ...] computedPropertySpacing option support (...)
...
// [prettierx merge update(s) from prettier@2.3.1 ...] for alignObjectProperties option
...
function printProperty(path, options, print) {
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] calculate property padding
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] FUTURE TBD: it should be possible to refactor the code
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] calculate this overhead in case it is needed,
  // with computedPropertySpacing option support:
  const computedPropertyOverhead = options.computedPropertySpacing ? 4 : 2;

  // [prettierx merge update(s) from prettier@2.3.1 ...] compose left part,
  // for alignObjectProperties option
  const propertyLeftPart = node.computed
    ? [
        // [prettierx merge update(s) from prettier@2.3.1 ...] computed property key,
    ...
    : [
        // [prettierx merge update(s) from prettier@2.3.1 ...] normal property key,
        // for alignObjectProperties option
  ...
  return printAssignment(
    ...
    options,
    print,
    // [prettierx merge update(s) from prettier@2.3.1 ...] with optional property alignment
    // for alignObjectProperties option
    propertyLeftPart,
    ":",
    "value"
