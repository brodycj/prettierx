...
const {
  ...
  hasAddedLine, // [prettierx merge update(s) from prettier@2.3.1 ...] for spaceInParens option support
...
function printFunction(path, print, options, args) {
  ...
  if (node.generator) {
    // [prettierx merge update(s) from prettier@2.3.1 ...] support generatorStarSpacing option (...)
  ...
  parts.push(
    ...
    group([
      // [prettierx merge update(s) from prettier@2.3.1 ...] spaceBeforeFunctionParen & generatorStarSpacing
      // option support (...)
...
function printMethod(path, options, print) {
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] with --generator-star-spacing option support (...)
  // A `getter`/`setter` can't be a generator, but it's recoverable
  if (value.generator) {
    parts.push("*");
    // [prettierx merge update(s) from prettier@2.3.1 ...] --generator-star-spacing option support (...)
...
// [prettierx merge update(s) from prettier@2.3.1 ...] with --space-before-function-paren option support (...)
function printMethodInternal(path, options, print) {
  ...
  const parts = [
    printFunctionTypeParameters(path, options, print),
    group([
      // [prettierx merge update(s) from prettier@2.3.1 ...] --space-before-function-paren option support (...)
...
function printArrowFunction(path, options, print, args) {
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] spaceInParens option support (...)
  ...
  if (
    ...
    // [prettierx merge update(s) from prettier@2.3.1 ...] with spaceInParens option support (...)
  ...
  // [prettierx merge update(s) from prettier@2.3.1 ...] with --paren-spacing option support (...)
  ...
  return group(
    ...
    // [prettierx merge update(s) from prettier@2.3.1 ...] --paren-spacing option support (...)
