...
function printMemberChain(path, options, print) {
  ...
  function printIndentedGroup(groups) {
    ...
    // [prettierx merge update(s) from prettier@2.3.1 ...]: --no-indent-chains option support
  ...
  //  * [prettierx merge update(s) from prettier@2.3.1 ...] --break-long-method-chains option if enabled:
  ...
  if (
    nodeHasComment ||
    // [prettierx merge update(s) from prettier@2.3.1 ...] breakLongMethodChains option support
