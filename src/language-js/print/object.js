...
// [prettierx merge update(s) from prettier@2.3.1 ...]: objectCurlySpacing, typeCurlySpacing option support
/**
...
function getFieldAndSpacing(node, options) {
  switch (node.type) {
    ...
    // [prettierx merge update(s) from prettier@2.3.1 ...]: typeCurlySpacing option support
