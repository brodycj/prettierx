...
| break before statement                               | `never`       | `--break-before-statement`                 | see [./docs/options.md](./docs/options.md) | Always add a line break before statement following if, else, for, for await, for each, do, while, and with.                                                                                        |
