...
| break before statement                               | `never`       | `--break-before-statement`                 | see [./docs/options.md](./docs/options.md) | Always add a line break before statement following if, else, which, for, for await, for each, do, and while.                                                                                        |
